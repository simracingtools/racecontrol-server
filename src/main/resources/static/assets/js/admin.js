...
function editWorkflowAction(actionId) {
  const workflowName = $("#action-tr-" + actionId + " #workflowName").val();
  $("#" + workflowName+ "-modal-" + actionId + " #id").val($("#action-tr-" + actionId + " #id").val());
  $("#" + workflowName+ "-modal-" + actionId + " #eventId").val($("#action-tr-" + actionId + " #eventId").val());
  $("#" + workflowName+ "-modal-" + actionId + " #workflowItemId").val($("#action-tr-" + actionId + " #workflowItemId").val());
  $("#" + workflowName+ "-modal-" + actionId + " #message").val($("#action-tr-" + actionId + " #editActionMessage").val());
  changeFormGroupDisplay(workflowName, actionId);
  $("#" + workflowName+ "-modal-" + actionId).modal('show');
}

function changeFormGroupDisplay(workflowName, actionId) {
  const stateKey = $("#" + workflowName+ "-modal-" + actionId + " #targetStateKey").val();
  $("#" + workflowName+ "-modal-" + actionId + " #targetStateKey > option").each(function() {
    if(this.value === stateKey) {
      $("#" + workflowName+ "-modal-" + actionId + " #targetStateKey").prop("style", $(this).attr("style"));
    }
  });
}
